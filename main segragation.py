...
class Schelling:
    def __init__(self, width, height, empty_ratio, similarity_threshold, n_iterations, races = 8):
        self.width = width 
        self.height = height 
        self.races = races
...
schelling_1 = Schelling(4, 4, .25, 0.3, 500, 2)
schelling_1.populate()
schelling_1.empty_houses = [(0, 2), (1, 3), (2, 0), (3, 0)]
schelling_1.agents = {(0, 0): 1, (0, 1): 2, (0, 3): 1, (1, 0): 1, (1, 1): 1, (1, 2): 2, (2, 1): 2, (2, 2): 1, (2, 3): 1, (3, 1): 2, (3, 2): 1, (3, 3): 2}
schelling_1.update()
